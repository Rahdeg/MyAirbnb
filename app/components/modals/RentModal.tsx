    ...
    if (step === STEPS.INFO) {
        bodyContent = (
            <div className=' flex flex-col gap-8'>
               ...
               <Counter title='Number of guests' subtitle='How many guest'/>
            </div>
        )
    }

  return (
   <Modal onClose={rentModal.onClose} onSubmit={onNext} actionLabel={actionLabel} secondaryActionLabel={secondaryActionModel} isOpen={rentModal.isOpen} title='Airbnb your home!' secondaryAction={step === STEPS.CATEGORY ? undefined : onBack} body={bodyContent}/>
  )
}
